...
const menuLinkClass =
	"block px-4 py-3 text-[#666] rounded-md transition-all duration-300 hover:bg-indigo-500 hover:text-white";
const menuLinkActiveClass =
	"block px-4 py-3 rounded-md transition-all duration-300 bg-indigo-500 text-white";
		...
		<aside className="bg-[#f8f9fa] p-8 rounded-lg h-fit flex gap-4 md:block">
			...
			<ul className="list-none p-0 m-0 flex gap-2 flex-wrap md:block">
				<li className="mb-2 flex-1 min-w-[100px] md:flex-none md:min-w-0">
					<Link
						href="/admin"
						className={
							pathname === "/admin" ? menuLinkActiveClass : menuLinkClass
						}
					>
						Dashboard
					</Link>
			...
			>
				...
				<button
					...
					className="mt-4 text-sm text-[#666] underline hover:text-[#333]"
				>
					Log out
				</button>
			</div>
