...
export const SOCIAL_LINKS: Array<{ key: IconName; label: string; url: string; show: boolean }> = [
  { key: 'x', label: 'X', url: 'https://x.com/RaulBN_', show: true },
  { key: 'bluesky', label: 'Bluesky', url: 'https://bsky.app/profile/raulbn.bsky.social', show: true },
  { key: 'cara', label: 'Cara', url: 'https://cara.app/raulbn', show: true },
  { key: 'vgen', label: 'vGen', url: 'https://vgen.co/RaulBN', show: true },
  { key: 'artstation', label: 'ArtStation', url: 'https://www.artstation.com/raulbn', show: true },
];
