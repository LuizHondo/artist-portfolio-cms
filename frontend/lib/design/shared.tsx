...
export function Icon({
	...
	switch (name) {
		...
		case "cara":
			...
			return (
				// biome-ignore lint/performance/noImgElement: fixed local asset, no next/image config needed
				<img
					src="/icons/cara.png"
					width={size}
					height={size}
...
export function PlaceholderImg({
	...
	return (
		...
		>
			{src && (
				// biome-ignore lint/performance/noImgElement: arbitrary admin-entered URLs, see design.md
				<img
					src={src}
					alt={alt}
					style={{
