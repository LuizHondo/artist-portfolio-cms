  ...
  return (
    <Paper style={s.page}>
      ...
      <section style={s.hero}>
        {/* eslint-disable-next-line @next/next/no-img-element -- static portrait, not from an admin-entered URL */}
        <img
        ...
        <div style={s.heroRight}>
          ...
          <div style={s.bigTag}>Illustrator · Character Design · Concept Art</div>
          <div style={s.bio}>
            <p style={s.bioP}>
              What&apos;s up — I&apos;m a Brazilian illustrator passionate about coffee, cats, and beautifully designed
              books.
            </p>
            <p style={s.bioP}>
              With a background in Animation Design, I focus on the conceptual side of projects — ideation, planning,
              and visual development. I love stories where a single frame holds enough light, shadow, and acting to
              make you stop and look closer.
            </p>
            <p style={s.bioP}>Available for commissions, concept work, and the occasional cover.</p>
          </div>

          <div style={{ marginTop: 36, paddingTop: 24, borderTop: '1px solid rgba(26,23,20,0.18)' }}>
            <div
              style={{
                fontFamily: '"IBM Plex Sans", "Helvetica Neue", sans-serif',
                fontSize: 11,
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10 }}>
              {enabledSocials.map((social) => (
                <a key={social.key} href={social.url} target="_blank" rel="noreferrer" style={s.socialChip} title={social.url}>
